...
local globalKeys = awful.util.table.join(
  ...
  awful.key(
    ...
    {description = 'cycle counter clockwise', group = 'client'}
  ),
  awful.key(
    {modkey, 'Shift'},
    'k',
    ...
    {description = 'cycle clockwise', group = 'client'}
  ),
  ...
  awful.key(
    ...
    'j',
    function()
      awful.util.spawn('idea')
    end,
    {description = 'open IntelliJ', group = 'launcher'}
  ),
  awful.key(
    {modkey},
    'v',
    function()
      awful.util.spawn('rofi-virtualbox.sh')
    end,
    {description = 'Virtualbox menu', group = 'launcher'}
  ),
  awful.key(
    {modkey},
    'b',
  ...
  awful.key(
    ...
    'a',
    function()
      awful.spawn('rofi_audio_move_sink_input.py')
    end,
    {description = 'change audio output', group = 'hotkeys'}
  ),
  -- ALSA volume control
  awful.key(
    {},
